...
urlpatterns = [
    ...
    # ticket-priority
    path("ticket-priorities/", TicketPriorityCreateListApiView.as_view(), name="ticket-priority-create-list"),
    path("ticket-priority/<pk>/", TicketPriorityDetailsApiView.as_view(), name="ticket-priority-details"),
    #ticket-status
    path("ticket-status/", TicketStatusCreateListApiView.as_view(), name="ticket-status-create-list"),
